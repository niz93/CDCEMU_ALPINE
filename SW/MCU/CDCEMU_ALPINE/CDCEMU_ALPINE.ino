...
#define PlayBT 8    // Пин воспроизведения
#define PauseBT 11  // Пин паузы
#define SkipFBT 10  // Пин переключения вперёд
#define SkipBBT 9   // Пин переключения назад

// Adapted to Teensy.
#define MBUS_IN_PIN 3  // Input port.
#define MBUS_IN_PIN_INTERRUPT MBUS_IN_PIN
#define MBUS_OUT_PIN 2           // Output port.
